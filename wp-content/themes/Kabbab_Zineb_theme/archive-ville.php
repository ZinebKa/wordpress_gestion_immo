<?php get_header() ?>
<h1 class="font-weight-bold text-center" style="padding:20px"> Mes villes </h1>
<?php $monPost = new WP_Query( array( 'post_type' => 'ville', 'posts_per_page' => '5' ) ); ?>
<?php if (have_posts()) : ?>
    <div class="row">
            ...
            <div class="card border-secondary mb-3" style="width: 18 rem; height: 20 rem">    
                ...
                <h2 class="card-title text-center" style="padding:10px"><?php the_title() ?></h5>
                        <h3 class="card-text" style="padding-left:20px">
                           Code postal: <?php the_field("code_postal") ?>. <br>
                        </h3>
